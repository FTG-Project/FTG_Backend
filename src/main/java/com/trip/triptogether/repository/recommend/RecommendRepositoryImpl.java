...
import static com.trip.triptogether.domain.QRecommendScrap.recommendScrap;
...
public class RecommendRepositoryImpl implements RecommendRepositoryCustom{
    ...
    public List<RecommendListResponse> recommendList(Category category, Area area) {
        ...
        JPQLQuery<Long> scraps = JPAExpressions
                .select(recommendScrap.user.id.count())
                .from(recommendScrap)
                .where(recommendScrap.recommend.id.eq(recommend.id));
